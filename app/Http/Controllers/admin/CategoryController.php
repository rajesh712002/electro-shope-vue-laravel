...
class CategoryController extends Controller
{
    ...
    public function category(Request $request)
    {
        ...
        // Pagination setup
        $categories = $categories->paginate(2); // Adjust pagination as needed

        // Return the categories and pagination data as a JSON response
        return response()->json([
    ...
    public function editCategory($id)
    {
        ...
        return response()->json(['success' => 'Catagory Inserted successfully', 'category' => $category]);
    }
    ...
    public function viewSubcategory(Request $request)
    {
        ...
        $subcategory = $subcategory->paginate(2);

        return response()->json([
            'subcategories' => $subcategory->items(),
            'pagination' => $subcategory->toArray()['links']
        ]);
    }
    // dd($subcategory);
    // if ($request->ajax()) {
    ...
    public function editSubcategory($id)
    {
        ...
        return response()->json(['success' => 'Catagory Inserted successfully', 'subcategory' => $subcategory, 'options'=>$options]);
...
//
    ...
    {
        $subcategory = Subcategory::where('subcate_id', $id)->where('status', 1)->select('id', 'subcate_name')->get();
