    ...
    methods: {
        async getCoupon() {
            try {
                ...
                const couponId = this.$route.params.id; // Get the ID from route
                const response = await axios.get(`/api/coupon-show/${couponId}`);
                console.log(response)
                this.form = response.data.couponCode;
            } catch (error) {
        ...
        //         const response = await axios.post(`/api/update-coupon/${couponId}`, this.form);
        ...
        //     try {
        //         const couponId = this.$route.params.id;
        //         // const response = await axios.post(`/api/update-coupon/${couponId}`, { ...this.form, _method: "PUT" });
        //         this.form.append("_method", "PUT");

        //         const response = await axios.post(`/api/update-banners/${bannerId}`, this.form, {
