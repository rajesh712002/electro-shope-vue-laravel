    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="container-fluid">
                <form action="{{route('admin.couponStore')}}" id="CouponCodeForm" name="CouponCodeForm" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="code" id="code" class=" form-control"
                                            value="{{ old('code') }}" placeholder="Coupon Code">
                                        <p></p>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" id="name" class=" form-control"
                                            value="{{ old('name') }}" placeholder="Coupon Name">
                                        <p></p>
                                        <h6 style="color: red" class="error"></h6>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="max_uses" id="max_uses" class=" form-control"
                                            value="{{ old('max_uses') }}" placeholder="Max Uses">
                                        <p></p>
                                        <h6 style="color: red" class="error"></h6>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="max_uses_user" id="max_uses_user" class=" form-control"
                                            value="{{ old('max_uses_user') }}" placeholder="Max Uses User">
                                        <p></p>
                                        <h6 style="color: red" class="error"></h6>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="discount_amount" id="discount_amount"
                                            class=" form-control" value="{{ old('discount_amount') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="min_amount" id="min_amount" class=" form-control"
                                            value="{{ old('min_amount') }}" placeholder="Minimum Amount">
                                        <p></p>
                                        <h6 style="color: red" class="error"></h6>
                                    </div>
                                </div>
